...
export class UsersModule extends ModuleBase {
	...
	getUserForClient(client) {
		...
		if(!auth) {
			// null will signify no authentication context, not logged in
			return null;
		}
	...
	loginClient$(client, username) {
		...
		// AuthContext is an object that contains authentication data - such as username, color, or logged in
